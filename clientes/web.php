...
<div id="wrap">
	<?php 
        ...
        $codigo=mysql_query("SELECT Nombre, Slogan FROM tblWeb where tblClientes_idClientes = '$_SESSION[id]'");
    ?>
                            ...
                            if (mysql_num_rows($codigo) > 0) {
                                while ($row=mysql_fetch_array($codigo)) {
                                    ...
                                    echo '
                                        ...
                                        <td>'.$row[Nombre].'</td>
                                        <td>'.$row[Slogan].'</td>
                                        <td><a href="detalle.php?id="'.$_SESSION[id].'">Detalle</a></td>
                                    ';
                                    $cont++;
                                }
                            }else{
                                echo '<td colspan="4">No hay ninguna web activa</td>';
                            }
                        ?>
