    ...
    <!-- begin content -->
        <section id="content" class="container clearfix">
            ...
            ?>
                    ...
                    <form class="content-form" name="contra" id="actualiza" method="post" action="../actions/actualizaContra.php">
                    <p>
                    <label for="usuario">Vieja Contraseña:<span class="note">*</span></label>
                    <input name="old_psw" type="password">
                </p>
                 <p>
                    <label for="mail">Nueva Contraseña:<span class="note">*</span></label>
                    <input name="new_psw" type="password">
                </p>
                 <p>
                    <label for="nombre">Confirma Contraseña:<span class="note">*</span></label>
                    <input name="cpsw" type="password">
                </p>
                <p>
                    <input class="button" value="Cambiar" onclick="valida_contra()" type="button">
                </p>
            </form>
            </div>
