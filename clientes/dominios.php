...
<div id="wrap">
	<?php 
        ...
        $codigo=mysql_query("SELECT Dominio, tblWeb_idWeb FROM tblDominios where tblClientes_idClientes = '$_SESSION[id]'");
    ?>
    ...
    <!-- begin content -->
        <section id="content" class="container clearfix">
            ...
            <div class="two-thirds column-last">
                <h2>Mis dominios</h2>
                <form  method="post" action="../actions/insertaDominios.php">
                    <p>
                    <label for="dominio">Dominio:<span class="note">*</span></label>
                    <input name="dominio" type="text">
                </p>
                <p>
                    <input class="button" value="Grabar" type="submit">
                </p>
            </form>
                            ...
                            if (mysql_num_rows($codigo) > 0) {
                                while ($row=mysql_fetch_array($codigo)) {
                                    ...
                                    <tr>
                                        <td>'.$cont.'</td>
                                        <td>'.$row[Dominio].'</td>
                                        <td>'.$row[tblWeb_idWeb].'</td>
                                        <td><a href="detallePago.php?id="'.$_SESSION[id].'">Detalle</a></td>
                                    </tr>
                                    ';
                                    $cont++;
                                }
                            }else{
                                echo '<tr><td colspan="4">No se ha confirmado ningún pago aún</td></tr>';
                            }
                        ?>
	...
	<!-- begin footer -->
	<?php include '../includes/footerClientes.php'; mysql_close();?>
	<!-- end footer -->
</div>
<!-- end container -->
