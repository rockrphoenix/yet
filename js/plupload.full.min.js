...
(function(e, t, n) {
    ...
    o.addFileFilter("mime_types", function(e, t, n) {
        e.length && !e.regexp.test(t.name) ? (this.trigger("Error", {
            ...
            message: o.translate("Sólo se admiten imágenes."),
            file: t
        }), n(!1)) : n(!0)
        ...
        e = o.parseSize(e), t.size !== r && e && t.size > e ? (this.trigger("Error", {
            ...
            message: o.translate("El tamaño de las imágenes debe ser menor a 10 mb."),
            file: t
        }), n(!1)) : n(!0)
            ...
            while (r--)
                if (t.name === this.files[r].name && t.size === this.files[r].size) {
                    this.trigger("Error", {
                        ...
                        message: o.translate("Imágenes duplicadas"),
                        file: t
                    }), n(!1);
                    return
                }
