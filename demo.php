...
<head>
    ...
    <script src="js/validaDemo.js" type="text/javascript"></script><!-- form validation -->
    ...
    <!-- begin content -->
        <section id="content" class="container clearfix">
            ...
            <header id="page-header">
            	<h1 id="page-title">Solicitar demo</h1>	
            </header>
            <!-- end page header -->
            ...
            <!-- begin contact form -->
            <h2>Contáctanos</h2>
            <p>En Yet! Inmobiliario estamos para servirte y con gusto te atenderemos. Sólo llena el formulario de abajo y en breve un ejecutivo se pondrá en contacto contigo para enviarte el demo.</p>
            ...
            <form id="demo" class="content-form" method="post" action="actions/procesa.php">
                <p>
                ...
                <p>
                    <br><input type="hidden" name="action" value="demo">
            ...
            <aside id="sidebar" class="one-fourth column-last">
            	<div class="widget contact-info">
                    ...
                    <p class="phone"><strong>Tel:</strong> +52-55-50296481</p>
