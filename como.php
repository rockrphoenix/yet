            ...
            <div class="infobox">
                <div class="infobox-inner">
                    ...
                    <div class="with-button">
                        <h2>Paso 1</h2>
                        <p><a href="zona.php#tab-2">Regístrate</a> en nuestro sitio web llenando un pequeño formulario y confirma tu correo electrónico.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            ...
            <div class="infobox">
                <div class="infobox-inner">
                    ...
                    <div class="with-button">
                        <h2>Paso 3</h2>
                        <p>Sube los datos de tu inmobiliaria, sube tu logotipo, elige tus colores y tu sitio web está casi listo.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            ...
            <div class="infobox">
                <div class="infobox-inner">
                    ...
                    <div class="with-button">
                        <h2>Paso 4</h2>
                        <p>Comienza a subir tus propiedades por medio de tu panel de control y tu sitio web estará completo</p>
                    </div>
                </div>
            </div>
        </section>
