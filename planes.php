...
if ($dominio=="yetinmobiliario.com") {
    $moneda="$140 más impuestos";
    $moneda2="$239 más impuestos";
    $moneda3="$423 más impuestos";
    $denominacion="Precios expresados en dolares americanos";

}else{
    $moneda="$1,800 más IVA";
    $moneda2="$3,100 más IVA";
    $moneda3="$5,500 más IVA";
    $denominacion="Precios expresados en pesos mexicanos";
}
?>
<!DOCTYPE HTML>
    ...
    <section id="content" class="container clearfix">
                ...
                <table class="gen-table pricing-table responsive">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td><a class="button" href="zona.php#tab-2">Ordenar</a></td>
                        </tr>
                    </tfoot>
                    <tbody>
                        <tr>
                        ...
                        <tr class="row-last">
                         ...
                         <tr class="row-last">
                            ...
                            <td><?php echo $moneda2; ?></td>
                        </tr>
                        <tr class="row-last">
                            <th>Pago Anual</th>
                            <td><?php echo $moneda3; ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <!-- end pricing table - style 2 -->
            <div class="one-half column-last">
                <a href="zona.php#tab-2"><div class="infobox">
                    <div class="infobox-inner">                    
                        <div class="with-button">
                            <h2>Regístrate</h2>
                            <p>Para que puedas adquirir uno de nuestros paquetes es necesario tu previo registro.</p>
                        </div>
                    </div>
                </a>
                    ...
                    <div class="infobox-inner">                    
                        <div class="with-button">
                            <h2>Arma tu propio paquete</h2>
                            <p>Puedes agregar características al paquete que contrates, agrega más asesores inmobiliarios y más cuentas de correo por un costo extra.</p>
                        </div>
                    </div>
                    <div class="infobox-inner">                    
                        <div class="with-button">
                            <h2><?php echo $denominacion; ?></h2>
