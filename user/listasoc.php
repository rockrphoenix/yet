            ...
            <section id="content" class="container clearfix">
                <!-- begin page header -->
                 <header id="page-header">
                    <h1 id="page-title">Listado de asociaciones</h1>
                </header>
                <div id="list_asoc">
                ...
                $arrayasoc=$encontradas->muestraAsoc();
                //print_r($arrayasoc);
                while ($asoc=$arrayasoc->fetch_array(MYSQL_ASSOC)) {
                 $asoci .="<tr>
                            <td></td>
                            <td>".$asoc['titulo']."</td>
                            <td>".$asoc['url']."</td>
                            <td><div>
                                    <div style='width:50%; display:inline-block'><a href='asoci.php?idas=".$asoc['idasoc']."'>Editar</a></div><div style='width:50%; display:inline-block'><a href='ocAsoci.php?idas=".$asoc['idasoc']."'>Borrar</a></div>
                            </div></td>
                        </tr>";
                 }
                 echo $asoci;
