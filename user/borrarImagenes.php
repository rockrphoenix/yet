        ...
        <section id="content" class="container clearfix">
        	<!-- begin page header -->
             <header id="page-header">
                <h1 id="page-title">Eliminar imágenes</h1>
            </header>
            <p>Elija las imágenes que desea borrar.</p>
            <?php if ($_GET[msj] == 1) { ?>

                <div class="notification-box notification-box-warning">
                    <p>Se borraron <?php echo $_GET['action'] ?> imagen(es).</p>
            ...
            <select class="image-picker show-html" name="edita_imagen[]" multiple="multiple">
              <?php echo $str ?>
            </select>
            <input type="hidden" name="action" value="borraImagen">
